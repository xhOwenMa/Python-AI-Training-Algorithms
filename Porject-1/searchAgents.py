...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # since none of the corners have been visited
        # no need to declare an initial state since the default is 0
        # and we will consider 0 as not visited
    ...
    def isGoalState(self, state):
        ...
        if state[0] in self.corners:
            ...
            # len == 4 means all 4 corners have been visited
            # and thus appended to the list
        return False
        util.raiseNotDefined()
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                succ = ((newPosition, visited), action, 1)
...
def cornersHeuristic(state, problem):
    ...
    while remainingCorners:
        ...
        minDistance, corner = min(distances)
        h += minDistance
...
def foodHeuristic(state, problem):
    ...
    for food in remainingFood:
        ...
        # manhattan seems to expand more nodes than necessary
        # mazeDistance used bfs, which logically makes sense
